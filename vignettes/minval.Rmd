...
```{r}
glycolysis$REACTION[12] <- "alpha-D-Glucose[c] <=> alpha-D-Glucose[b]"
glycolysis$REACTION[4]  <- "D-Glyceraldehyde 3-phosphate[c] <=> Glycerone phosphate[c]"
...
```{r}
glycolysis$REACTION[10] <- "ADP[c] + Phosphoenolpyruvate[c] => Pyruvate[c] + ATP[c]"
glycolysis$REACTION[11] <- "2-Phospho-D-glycerate[c] <=> Phosphoenolpyruvate[c] + H2O[c]"
