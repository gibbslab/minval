...
#' @description This function converts a XLS spreadsheet data to a valid SBML file. The Systems Biology Markup Language (SBML) is a representation format, based on XML, for communicating and storing computational models of biological processes.
#' More Info: Encyclopedia of Systems Biology Dubitzky, W., Wolkenhauer, O., Yokota, H., Cho, K.-H. (Eds.) SBML, pp2057-2062 Springer 2013.
#' @details This function takes a XLS spreadsheet as input and convert it to a valid sbmlR object, then the object is written into the SBML output file.
#' @param infile A XLS spreadsheet with the following mandatory colnames: \itemize{
