...
#' \item \code{"REACTION":} A set of stoichiometric reaction with the following format: 
#' \code{"H2O[c] + Urea-1-carboxylate[c] <=> 2 CO2[c] + 2 NH3[c]"} Where arrows and plus signs are surrounded by a "space character".
